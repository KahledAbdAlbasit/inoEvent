        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav mx-auto mb-2 mb-lg-0" {{ app()->getLocale() == 'ar' ? 'dir=rtl' : '' }}>
                    <li class="nav-item">
                        <a class="nav-link text-light fw-bold @yield('home')" aria-current="page" href="{{ url('/') }}">@lang('Home')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fw-bold @yield('events')" href="{{ url('events') }}">@lang('Explore Events')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fw-bold" href="#">@lang('About Us')</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light fw-bold" href="#">@lang('Contact Us')</a>
                    </li>
                </ul>
                <div class="d-flex align-items-center">
                    ...
                    @endif
                    @if (Auth::check())
                    <a href="{{ url('/logout') }}" class="text-light py-2 px-3 signup me-3" type="submit">@lang('Logout')</a>
                    @endif
                    <div class="dropdown">
                        <button class="bg-transparent lang text-light border-0 dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                            @if (app()->getLocale() == 'ar')
                            AR
        ...
        <div class="container position-relative">
            <div class="row h-100">
                <div class="col-md-8 d-grid home-box mb-4">
                    <div class="box-left text-center  {{ app()->getLocale() == 'ar' ? 'text-md-end' : 'text-md-start' }}">
                ...
                <div class="col-md-4 d-grid home-box">
                    <div class="box-right">
                        <a href="{{ isset($now_event) ? 'events/' . $now_event[0]->id : '#' }}" class="a-1 rounded-pill bg-main-2 text-light d-block mx-auto mb-4 {{ app()->getLocale() == 'ar' ? 'fw-bold' : '' }}">@lang('RESERVE YOUR SEAT')</a>
                        <a href="{{ url('events') }}" class="a-2 rounded-pill text-light d-block mx-auto {{ app()->getLocale() == 'ar' ? 'fw-bold' : '' }}">@lang('See More')</a>
                    </div>
                </div>
            </div>
        </div>
