    ...
    <div class="card-body">
        <form action="{{route('dashboard.events.store')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        <label class="form-label">Link <span class="text-red">*</span>
                            <button type="button">
                                <a href="https://www.artsteps.com" target="_blank" rel="noopener noreferrer">Go to artsteps to create link for new event </a></button>
                        </label>
