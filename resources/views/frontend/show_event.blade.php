        ...
        <div class="modal-content">
            ...
            <form action="{{ route('payment') }}" method="post">
                ...
                <div class="modal-footer">
                    <button type="button" class="bg-secondary py-2 px-4 text-light rounded-pill border-0" data-bs-dismiss="modal">Close
                    </button>
    ...
    <div class="container">
        ...
        <div class="row ticket_footer mt-5 pt-5">
            ...
            <div class="col-md-4 d-flex align-items-center justify-content-center">
                @if ($event->tickets->isEmpty())
                @else
                <a type="button" data-bs-toggle="modal" data-bs-target="#exampleModal" class="bg-main-2 py-2 px-4 text-light rounded-pill">@lang('Get Ticket')</a>
                @endif
            </div>
        </div>
    </div>
    ...
    <div class="container">
        <div class="">
            @if ($event->start_date <= now() and $event->end_date > now())
                ...
                @endif
                <iframe id="event" src="{{ $event->link }}" class="w-100" height="600" frameborder="0" allowfullscreen></iframe>
